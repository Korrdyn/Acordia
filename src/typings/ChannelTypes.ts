...
export type ChannelTypes = BaseChannel | GuildTextChannel | GuildVoiceChannel | GuildVoiceTextChannel | GuildStageChannel | GuildCategoryChannel | GuildForumChannel | GuildStoreChannel | GuildNewsChannel | GuildThreadChannel;
